  ...
  ({
    ...
    return (
      <>
        ...
        <div className="lg:hidden mb-6 flex gap-2 sticky top-0 z-40 bg-white py-3">
          <button
        ...
        >
          <div className="bg-white rounded-t-3xl shadow-2xl max-h-[85vh] overflow-y-auto">
                ...
                {openSections.positions && (
                  <div className="mt-3 animate-slideDown">
                    <input
                      ...
                      value={positionsFilter}
                      onChange={(e) => onPositionsFilterChange(e.target.value)}
                      className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-ku-pine focus:border-transparent transition-shadow text-sm text-gray-900 placeholder:text-gray-400"
                    />
                  </div>
                )}
              </div>
            ...
            {/* Drawer Footer */}
            <div className="sticky bottom-0 bg-gradient-to-t from-white via-white to-white/90 border-t border-gray-100 px-6 py-4 space-y-3">
              <button
                onClick={onClearFilters}
                className="w-full px-4 py-2.5 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-200 transition-all duration-150 border border-gray-200"
                aria-label="Clear all filters"
              >
                Clear All
              </button>
              <button
                onClick={closeDrawer}
                className="w-full px-4 py-3 bg-ku-pine hover:bg-ku-pine-dark text-white rounded-lg text-sm font-semibold transition-all duration-200 active:scale-95"
              >
                Apply Filters
              </button>
            </div>
