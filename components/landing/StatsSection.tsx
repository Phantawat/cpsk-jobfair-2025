...
export const StatsSection: React.FC<StatsSectionProps> = React.memo(
  ({ companies }) => {
    ...
    return (
      <section className="py-16 sm:py-20 md:py-24 bg-gray-50 overflow-x-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="text-center mb-12 sm:mb-16 animate-fadeInUp">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
              Join us to discover opportunities from leading companies across
              diverse industries
            </p>
          </div>
...
const StatCard: React.FC<StatCardProps> = React.memo(
  ({ stat, index, hasAnimated }) => {
    ...
    return (
      ...
      >
        ...
        <div className="text-5xl sm:text-6xl font-bold text-ku-pine text-center mb-2 group-hover:text-ku-fresh transition-colors duration-300 inline-block w-full">
        ...
        {/* Label */}
        <div className="text-lg sm:text-xl text-gray-600 text-center font-medium">
          {stat.label}
        </div>
  ...
  (prevProps, nextProps) => {
    // Only re-render if hasAnimated changes or stat value changes
    return (
