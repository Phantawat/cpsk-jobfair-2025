                    ...
                    (company, index) => {
                      ...
                      return (
                        <Link
                          ...
                          className="group flex-shrink-0 w-28 sm:w-32 text-center hover-lift transition-transform duration-300 focus-shadow rounded-full outline-none focus:outline-offset-2 focus:outline-ku-pine"
                        >
                          {/* Company Logo Circle */}
